...
static PARAM_SET ParamSets[] = {
    {
        ...
        55,                 /* maximum length of a message (in bytes) */
    },
    {
        ...
        92,                 /* maximum length of a message (in bytes) */
    },
    {
        ...
        115,                  /* standard deviation, ~ 2^10.5 */
        448,                   /* degree for karatsuba */
        34,                 /* maximum length of a message (in bytes) */
    },

    {
        ...
        115,                  /* standard deviation, ~ 2^10.5 */
        768,                   /* degree for karatsuba */
        74,                 /* maximum length of a message (in bytes) */
    },
};
